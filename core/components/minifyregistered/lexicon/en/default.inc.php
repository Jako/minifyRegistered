...
$_lang['setting_minifyregistered.groupJs'] = 'Group minified files in `groupFolder`';
$_lang['setting_minifyregistered.groupFolder'] = 'Group files in this folder with `groupJs` enabled';
$_lang['setting_minifyregistered.minPath'] = 'Path to a working minify installation';
$_lang['setting_minifyregistered.excludeJs'] = 'Comma separated list of files (including pathnames) not to be minified';

$_lang['setting_minifyregistered.enableBuilder'] = 'Allow use of the Minify URI Builder app';
$_lang['setting_minifyregistered.enableBuilder_desc'] = 'Only set this to true while you need it.';
